...
await page.screenshot({ path: '../.shots/web_v5_final_dark.jpeg', fullPage: true, quality: 80, type: 'jpeg' });
await page.evaluate(() => document.getElementById('themeBtn').click());
await new Promise(r => setTimeout(r, 800));
await page.screenshot({ path: '../.shots/web_v5_final_light.jpeg', fullPage: true, quality: 80, type: 'jpeg' });
